...
оклад и премия, например, {"wage": wage, "bonus": bonus}. Создать класс Position (должность) на
...
director = Position("Alex", "Petrov", "Director", 200000, 50000)

print(f"{director.worker()}\n{'*' * 70}\n{director.get_full_name()}\n{director.get_total_income()}")
